 ...
 * méthode rédefinissent de façon anonyme la méthode <code> test(T t) </code> de
 * l'inteface fonctionnelle <code>java.util.function.Predicate</code>
 * 
...
public final class Filters {
    ...
    /**
     * Retourne un <code>Predicate</code> qui est vrai ssi la valeur attribuée à
     * laquelle on l'applique possède l'attribut ayant le nom de l'arument et si
     * de plus la valuer associée à cet attribut fait partie de celles données
     * 
     * @param attributeName
     *            le nom de l'attribut dont on veut vériier l'appartenance à la
     *            valeur attribuée
     * @param attributeValues
     *            tableau de valeurs dont on veut véfirifer l'association avec
     *            le paramètre attributeName. L'ellipse permet à l'utilisateur
     *            de fournir à la méthode un nombre variable de valeurs sans
     *            devoir définir une <code>Collection</code>.
     * 
     * @return Un filtre (<code>Predicate</code>)
     */
    public static Predicate<Attributed<?>> tagged(String attributeName,
        ...
        return x -> {
            ...
            // attributeName est le nom d'un attribut possedé par la valeur
            // attribuée
     ...
     * @return Un fltre (<code>Predicate</code>)
     * @throws <code>IllegalArgumentException</code> lancée si le paramètre
     *         identifiant la couche est un entier inférieur à -5 ou supérieur à
     *         5
     */
